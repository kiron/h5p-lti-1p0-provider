exports.model = model => `<html style="max-width: inherit;">
<head>
<meta charset="UTF-8">
...
<form method="post" enctype="multipart/form-data" id="h5p-content-form" style="margin:0 auto; max-width:900px;">
    ...
    <input type="submit" name="submit" value="Save" style="float:right; margin:30px 0;" 
    class="h5peditor-button h5peditor-button-textual importance-high">
</form>
<script>
var ns = H5PEditor;
(function($) {
